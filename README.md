...
而是把跨城市房源、预算、板块调研、现场证据和 AI 复盘放进同一个私人工作台。
...
- 市场页覆盖国家统计局 70 城 2024—2026 年新房、二手房指数，支持切换城市、年份、环比、同比和时间范围。
- 预算压力模型，估算首付、税费预留、月供和现金缺口。
- 本地 Codable 持久化，不向开发者服务器上传地址、收入或个人笔记；地图坐标由 Apple MapKit 解析。
...
1. 在数据许可范围内接入重点城市成交、可售和挂牌数据。
2. 相机、语音与 OCR 快速录入现场证据。
3. 通勤锚点与多时段路线对比。
4. 经用户授权的房源链接自动导入和跨平台去重。
5. 按城市维护政策快照与来源更新时间提示。
6. 产权、贷款和签约材料的隐私保险箱。
